...
export default function CareerInterest({ name, role, email, siteUrl }: CareerInterestProps) {
  return (
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={h1}>We received your interest</Text>
            <Text style={text}>Hi {name || 'there'},</Text>
            <Text style={text}>
              Thank you for expressing interest in the <strong>{role || 'open'}</strong> position at VitaSignal. We're building the next generation of clinical intelligence and appreciate you considering joining our team.
            </Text>
            <Text style={text}>
              Our team will review your submission and reach out if there's a fit. Due to the volume of interest we receive, we may not be able to respond to every inquiry individually.
            </Text>
            <Section style={detailsBox}>
              <Text style={detailLabel}>What we're building</Text>
              <Text style={text}>Real-time pressure injury prevention powered by AI, continuous monitoring, and 11 patent-pending innovations. Join us at the intersection of clinical care and technology.</Text>
            </Section>
          </Section>
          <Hr style={hr} />
