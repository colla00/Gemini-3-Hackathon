...
export default function ReportReady({ name, reportName, downloadUrl, generatedAt, siteUrl }: ReportReadyProps) {
  return (
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={h1}>Your Report is Ready</Text>
            <Text style={text}>Hi {name || 'there'},</Text>
            <Text style={text}>
              Your report has been generated and is ready for download.
            </Text>
            <Section style={detailsBox}>
              <Text style={detailLabel}>Report</Text>
              <Text style={detailValue}>{reportName || 'Report'}</Text>
              {generatedAt && (
                <>
                  <Text style={detailLabel}>Generated</Text>
                  <Text style={detailValue}>{generatedAt}</Text>
                </>
              )}
            </Section>
            {downloadUrl && (
            ...
            <Text style={text}>
              Reports are available for 30 days. If you need assistance, contact us at <a href="mailto:info@vitasignal.ai" style={{ color: 'hsl(173,58%,29%)' }}>info@vitasignal.ai</a>.
            </Text>
          </Section>
          <Hr style={hr} />
...
const detailsBox: React.CSSProperties = { backgroundColor: '#eff6ff', borderRadius: '8px', padding: '20px 24px', margin: '0 0 20px', border: '1px solid #bfdbfe' }
