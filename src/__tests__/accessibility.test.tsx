...
describe('Accessibility - WCAG 2.1 AA Compliance', () => {
  ...
  // ============================================
  // SkipLink Variant Tests
  // ============================================
  describe('SkipLink Variants', () => {
    it('should render dashboard variant with multiple targets', () => {
      const { container } = render(
        <TestWrapper>
      ...
      const links = container.querySelectorAll('a');
      expect(links.length).toBe(3); // main-content, filters, patient-list
    });

    it('should render presentation variant', () => {
      const { container } = render(
        <TestWrapper>
          <SkipLink variant="presentation" />
        </TestWrapper>
      );
    ...
    it('should display keyboard shortcuts in skip links', () => {
      const { container } = render(
        <TestWrapper>
          <SkipLink variant="dashboard" />
        </TestWrapper>
  ...
  describe('Interactive Element Focus', () => {
    ...
    it('RiskBadge should support keyboard activation', () => {
      const { container } = render(
        <TestWrapper>
          <RiskBadge level="HIGH" />
        </TestWrapper>
  ...
  describe('ARIA Live Regions', () => {
    it('should have status role for risk indicators', () => {
      const { container } = render(
        <TestWrapper>
          <RiskBadge level="HIGH" />
        </TestWrapper>
  ...
  // ============================================
  // Touch Target Size Tests (WCAG 2.5.5)
  // ============================================
  describe('Touch Target Size', () => {
    it('PatientCard should have adequate touch target size', () => {
      const { container } = render(
        <TestWrapper>
          <PatientCard
            patient={mockPatient}
      ...
      const card = container.querySelector('article');
      // Card should be large enough for touch (minimum 44x44px recommended)
      // We verify it has padding/sizing classes that ensure adequate size
