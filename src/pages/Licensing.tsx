        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "What clinical validation has been completed?", a: "VitaSignal Mortality has been validated on large-scale ICU datasets (n=26,153) with strong predictive performance (AUC 0.741, 95% CI: 0.712-0.769; mean temporal AUC 0.684) and equity validation across 11 years of temporal validation (2008-2019). Other systems are in design phase requiring clinical validation studies. Detailed performance data available under NDA." },
