...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blog & Insights | VitaSignal</title>
        <meta name="description" content="Clinical AI insights, regulatory updates, and nursing informatics research from VitaSignal." />
      </Helmet>
      <LandingNav />
