...
const DEFAULT_NOTES: Record<number, string> = {
  ...
  16: `Research Validation\n• Multi-database validation: MIMIC-IV, eICU, HiRID.\n• IDI: 65K+ patients · DBS: 28K+ patients across 172 hospitals · SEDR: 94K+ ICU stays.\n• Manuscripts under review at target journals · CHITA 2026 accepted.`,
