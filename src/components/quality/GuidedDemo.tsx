...
const DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    title: 'Questions?',
    view: 'dashboard',
    narration: "Thank you for watching this demo. The methodology chatbot in the bottom right can answer technical questions. This technology is protected by 11 U.S. patent applications.",
    duration: 8,
    icon: <Presentation className="w-4 h-4" />,
    highlights: ['11 patent applications filed', 'Research prototype', 'Human-in-the-loop']
  }
];
