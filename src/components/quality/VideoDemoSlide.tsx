    ...
    <div className="w-full h-full bg-gradient-to-br from-background via-background to-primary/5 p-6 flex flex-col">
        ...
        <p className="text-sm text-muted-foreground flex items-center justify-center gap-2">
          {isHackathon ? (
            <>
              ...
              <span>CareGuard Clinical Dashboard • 3 Minute Overview</span>
            </>
          ) : (
        ...
        <Card className="w-full max-w-4xl border-2 border-primary/30 overflow-hidden shadow-xl">
          <CardContent className="p-0">
            ...
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                src={videoUrl}
                title={isHackathon ? "Gemini 3 Hackathon Demo" : "CareGuard Clinical Dashboard Presentation"}
      ...
      <div className="mt-4 text-center">
        <p className="text-xs text-muted-foreground">
          {isHackathon ? (
            <>
              Dr. Alexis Collier • Gemini 3 Hackathon 2026 Submission • 4 U.S. Patents Filed • 
