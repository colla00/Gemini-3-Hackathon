...
export const FullPDFExport = ({ claims, attestations, documentHash, documentVersion }: FullPDFExportProps) => {
  ...
  const generateFullPDF = async () => {
    ...
    try {
      ...
      pdf.text('Clinical Risk Intelligence System', pageWidth / 2, 48, { align: 'center' });
      ...
      pdf.setFontSize(10);
      pdf.setFont('helvetica', 'normal');
      const summaryText = `This document provides comprehensive evidence of the working implementation of the Clinical Risk Intelligence System, covering all 20 patent claims. The system integrates machine learning-based risk prediction with SHAP explainability, temporal forecasting, adaptive thresholds, and closed-loop intervention feedback for nurse-sensitive patient outcomes.
