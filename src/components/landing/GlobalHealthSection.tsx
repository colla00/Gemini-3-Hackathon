...
export const GlobalHealthSection = () => (
  <motion.section aria-labelledby="global-health-heading" className="py-24 px-6" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.7, ease: [0.25, 0.46, 0.45, 0.94] }}>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          {[
            ...
            { icon: Heart, label: "357K+ Patients", detail: "Large-scale evidence" },
