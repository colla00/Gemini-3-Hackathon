...
const metrics = [
  ...
  { label: "Patent #1 External", value: 0.9063, display: "0.9063", detail: "HiRID AUROC", prefix: "", suffix: "" },
  { label: "Patent #5 DBS", value: 172, display: "172", detail: "Hospitals validated", prefix: "", suffix: "" },
