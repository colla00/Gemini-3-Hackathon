...
export const PRESENTATION_SLIDES: SlideConfig[] = [
  ...
  },
  {
    ...
    talkingPoints: [
      ...
      'This video covers everything I present live, so you are not missing anything.',
      'I actually recommend pausing at certain points to explore the dashboard yourself — the link should be available in the description.',
  ...
  },
  {
    ...
    talkingPoints: [
      'This is my cheat sheet for Q&A — I put together common questions I anticipate and my planned responses.',
      'I grouped them by difficulty: easy questions I can answer confidently, medium ones that require nuance, and hard ones that get into areas where I need to be careful.',
      'The key thing I keep reminding myself: this is a research prototype. I should not overstate what I have validated.',
      'If someone asks about clinical outcomes, I emphasize that validation is still pending.',
      'If someone asks about regulatory status, I note that I am exploring FDA pathways but have not submitted anything yet.',
    ],
