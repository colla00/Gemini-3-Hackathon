...
export const PRESENTATION_SLIDES: SlideConfig[] = [
  ...
  },
  {
    ...
    notes: [
      'Present the TARGET metrics: AUROC 0.89, sensitivity 87%, specificity 86%',
      'Discuss the target reduction in preventable falls (30-40%)',
      'Highlight key patent innovations: multi-horizon forecasting, adaptive thresholds, closed-loop feedback',
      'Address planned study design',
      'Mention IRB submission planned',
    ],
    keyPoints: [
      'Target AUROC: 0.89',
      'Target Sensitivity: 87%, Specificity: 86%',
      'Target: 40-70% reduction in false positive alerts',
    ...
    talkingPoints: [
      ...
      'Target model performance: AUROC of 0.89, with 87% sensitivity and 86% specificity.',
      'Our adaptive thresholds target 40-70% reduction in false positive alerts.',
      'Key innovations: multi-horizon forecasting, patient-adaptive thresholds, closed-loop feedback.',
