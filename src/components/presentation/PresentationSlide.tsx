...
export const PRESENTATION_SLIDES: SlideConfig[] = [
  ...
  },
  {
    ...
    subtitle: '93K+ Patients • 172 Hospitals',
    duration: 4,
    icon: <Award className="w-8 h-8" />,
    notes: [
    ...
    keyPoints: [
      '24,689 patients in internal validation (MIMIC-IV)',
      '3,673 patients across 172 hospitals (eICU) in external validation',
      'DBS AUROC: 0.802 (internal), 0.758 (external) [0.734–0.782]',
      'NPV: 0.924 (internal), 0.947 (external)',
    ...
    talkingPoints: [
      ...
      'The Documentation Burden Score system was validated on 24,689 patients internally using MIMIC-IV, then externally validated across 172 hospitals using eICU with 3,673 patients.',
      'Internal AUROC reached 0.802. External validation achieved AUROC 0.758 with a 95% CI of 0.734 to 0.782.',
      'The negative predictive value was 0.947 externally — meaning 94.7% accuracy in ruling out low-burden shifts.',
