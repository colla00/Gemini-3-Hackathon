...
export const PRESENTATION_SLIDES: SlideConfig[] = [
  ...
  },
  {
    ...
    icon: <Award className="w-8 h-8" />,
    notes: [
      'Multi-site validation across 208 hospitals',
      '321,719 patients analyzed (MIMIC-IV + eICU)',
      'DBS System: AUROC 0.802 internal, 0.857 external',
      'Target: 87% alert reduction (simulated, not clinically validated)',
    ],
    keyPoints: [
      '24,689 patients in internal validation (MIMIC-IV)',
      '297,030 patients across 208 hospitals (eICU) in external validation',
      'DBS AUROC: 0.802 (internal), 0.857 (external)',
    ...
    talkingPoints: [
      ...
      'The Documentation Burden Score system was validated on 24,689 patients internally using MIMIC-IV, then externally validated across 208 hospitals using eICU with 297,030 patients.',
      'Internal AUROC reached 0.802. External validation achieved AUROC 0.857 — the model actually performed better on external data, which is unusual and speaks to its robustness.',
      'This is a multi-variable ML model with rigorous cross-validation and hyperparameter optimization.',
