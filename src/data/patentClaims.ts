...
const ICU_MORTALITY_CLAIMS: PatentClaim[] = [
  ...
  },
  {
    ...
    description: 'The system of claim 1, achieving AUC of 0.684 (95% CI: 0.653-0.715) for mortality prediction using only EHR timestamp metadata without requiring physiological monitoring equipment, enabling deployment in resource-limited settings.',
    category: 'system',
  ...
  },
  {
    ...
    category: 'system',
    implementation: 'Ensemble model comparison showing XGBoost (AUC 0.684), Random Forest (0.658), and Logistic Regression (0.641) with feature importance rankings.',
    componentPath: 'src/components/dashboard/Dashboard.tsx',
    status: 'demonstrated',
    demoSection: 'patents',
    patentId: 'icu-mortality'
