...
const narrationScripts: NarrationScript[] = [
  {
    view: 'dashboard',
    text: `Welcome to VitaSignal™. This is your command center for real-time patient risk monitoring. 
    ...
    academicText: `Welcome to our research demonstration of VitaSignal™, a novel clinical decision support system for nurse-sensitive outcome prediction.
